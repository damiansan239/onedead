  ...
  return (
    <div
      className={`
        ...
        shadow-[0_6px_10px_rgba(0,0,0,0.15),_inset_0_-4px_0_rgba(0,0,0,0.2),_inset_0_2px_4px_rgba(255,255,255,0.6)]
        transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-1.5 hover:rotate-0
        ${rotation}
        ${isRed 
          ? "bg-gradient-to-br from-red-500 to-rose-700 text-white border border-red-800 hover:shadow-[0_12px_20px_rgba(239,68,68,0.3),_inset_0_-4px_0_rgba(0,0,0,0.2),_inset_0_2px_4px_rgba(255,255,255,0.6)]" 
          : "bg-gradient-to-br from-white to-stone-200 text-stone-900 border border-stone-300 hover:shadow-[0_12px_20px_rgba(0,0,0,0.15),_inset_0_-4px_0_rgba(0,0,0,0.2),_inset_0_2px_4px_rgba(255,255,255,0.6)]"
        }
      `}
    >
      {/* 4 Corner Pips */}
  ...
  return (
    <button
      ...
      className={`
        ...
        active:translate-y-[3px] active:shadow-[0_1px_0_rgba(0,0,0,0.15),inset_0_1px_3px_rgba(0,0,0,0.15)]
        ${isPrimary
          ? `bg-gradient-to-b from-stone-900 to-stone-800 text-white border border-stone-950
          ...
          : `bg-gradient-to-b from-white to-stone-100 text-stone-800 border border-stone-300
...
const HomeScreen = ({
  ...
  const SoundIcon = soundOn ? SpeakerXMarkIcon : SpeakerWaveIcon;
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-3 justify-center">
              {[
                ...
                <Die key={`${die.letter}-${idx}`} letter={die.letter} rotation={die.rotation} isRed />
              ))}
            </div>
          </div>
        </section>
